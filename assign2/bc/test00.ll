...
define dso_local i32 @clever() #0 !dbg !19 {
  ...
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  call void @llvm.dbg.declare(metadata i32 (i32, i32)** %1, metadata !22, metadata !DIExpression()), !dbg !24
  store i32 (i32, i32)* @plus, i32 (i32, i32)** %1, align 8, !dbg !24
  ...
  store i32 2, i32* %3, align 4, !dbg !28
  call void @llvm.dbg.declare(metadata i32* %4, metadata !29, metadata !DIExpression()), !dbg !31
  %5 = load i32 (i32, i32)*, i32 (i32, i32)** %1, align 8, !dbg !32
  %6 = load i32, i32* %2, align 4, !dbg !33
  %7 = load i32, i32* %3, align 4, !dbg !34
  %8 = call i32 %5(i32 %6, i32 %7), !dbg !32
