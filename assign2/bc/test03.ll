...
13:                                               ; preds = %11, %1
  ...
  %15 = icmp eq i32 %14, 4, !dbg !56
  br i1 %15, label %16, label %18, !dbg !57

16:                                               ; preds = %13
  %17 = load i32 (i32, i32)*, i32 (i32, i32)** %4, align 8, !dbg !58
  store i32 (i32, i32)* %17, i32 (i32, i32)** %5, align 8, !dbg !60
  br label %18, !dbg !61

18:                                               ; preds = %16, %13
  %19 = load i32 (i32, i32)*, i32 (i32, i32)** %5, align 8, !dbg !62
  %20 = icmp ne i32 (i32, i32)* %19, null, !dbg !64
  br i1 %20, label %21, label %26, !dbg !65

21:                                               ; preds = %18
  call void @llvm.dbg.declare(metadata i32* %8, metadata !66, metadata !DIExpression()), !dbg !69
  %22 = load i32 (i32, i32)*, i32 (i32, i32)** %5, align 8, !dbg !70
  %23 = load i32, i32* %6, align 4, !dbg !71
  %24 = load i32, i32* %7, align 4, !dbg !72
  %25 = call i32 %22(i32 %23, i32 %24), !dbg !70
  store i32 %25, i32* %8, align 4, !dbg !69
  br label %26, !dbg !73
