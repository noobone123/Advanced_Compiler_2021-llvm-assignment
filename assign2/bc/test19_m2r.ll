...
define dso_local i32 @clever() #0 !dbg !32 {
  ...
  %1 = icmp sgt i32 1, 0, !dbg !41
  br i1 %1, label %2, label %3, !dbg !43
...
4:                                                ; preds = %3, %2
  %.0 = phi i32 (i32, i32)* [ @plus, %2 ], [ @minus, %3 ], !dbg !45
  call void @llvm.dbg.value(metadata i32 (i32, i32)* %.0, metadata !38, metadata !DIExpression()), !dbg !37
  %5 = call i32 @foo(i32 1, i32 2, i32 (i32, i32)* %.0), !dbg !46
  call void @llvm.dbg.value(metadata i32 %5, metadata !47, metadata !DIExpression()), !dbg !37
  ret i32 0, !dbg !49
}
...
!44 = !DILocation(line: 24, column: 6, scope: !42)
