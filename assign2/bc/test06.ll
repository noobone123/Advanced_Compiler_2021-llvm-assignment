...
22:                                               ; preds = %20, %16
  ...
  %24 = load i32, i32* %6, align 4, !dbg !78
  %25 = load i32 (i32, i32)*, i32 (i32, i32)** %9, align 8, !dbg !79
  %26 = call i32 @clever(i32 %23, i32 %24, i32 (i32, i32)* %25), !dbg !80
  store i32 %26, i32* %10, align 4, !dbg !76
  ret i32 0, !dbg !81
}
