...
13:                                               ; preds = %1
  %14 = load i32 (i32, i32)*, i32 (i32, i32)** %4, align 8, !dbg !54
  store i32 (i32, i32)* %14, i32 (i32, i32)** %5, align 8, !dbg !56
  br label %15

15:                                               ; preds = %13, %11
  %16 = load i32 (i32, i32)*, i32 (i32, i32)** %5, align 8, !dbg !57
  %17 = icmp ne i32 (i32, i32)* %16, null, !dbg !59
...
18:                                               ; preds = %15
  ...
  %21 = load i32, i32* %7, align 4, !dbg !67
  %22 = call i32 %19(i32 %20, i32 %21), !dbg !65
  store i32 %22, i32* %8, align 4, !dbg !64
  br label %23, !dbg !68
...
!1 = !DIFile(filename: "test02.c", directory: "/home/hikonaka/compiler_2021/hw_2/assign2/test")
!2 = !{}
!3 = !{!4}
