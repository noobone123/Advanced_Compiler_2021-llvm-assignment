...
define dso_local i32 @moo(i8 signext %0, i32 %1, i32 %2) #0 !dbg !53 {
  ...
  store i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)* @foo, i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)** %9, align 8, !dbg !69
  ...
  br i1 %13, label %14, label %22, !dbg !75

14:                                               ; preds = %3
  %15 = load i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)*, i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)** %9, align 8, !dbg !76
  %16 = load i32, i32* %5, align 4, !dbg !78
  %17 = load i32, i32* %6, align 4, !dbg !79
  %18 = load i32 (i32, i32)*, i32 (i32, i32)** %7, align 8, !dbg !80
  %19 = load i32 (i32, i32)*, i32 (i32, i32)** %8, align 8, !dbg !81
  %20 = call i32 (i32, i32)* %15(i32 %16, i32 %17, i32 (i32, i32)* %18, i32 (i32, i32)* %19), !dbg !76
  store i32 (i32, i32)* %20, i32 (i32, i32)** %10, align 8, !dbg !82
  %21 = load i32 (i32, i32)*, i32 (i32, i32)** %7, align 8, !dbg !83
  store i32 (i32, i32)* %21, i32 (i32, i32)** %8, align 8, !dbg !84
  br label %23, !dbg !85
...
23:                                               ; preds = %22, %14
  %24 = load i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)*, i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)** %9, align 8, !dbg !88
  %25 = load i32, i32* %5, align 4, !dbg !89
  %26 = load i32, i32* %6, align 4, !dbg !90
  %27 = load i32 (i32, i32)*, i32 (i32, i32)** %8, align 8, !dbg !91
  %28 = load i32 (i32, i32)*, i32 (i32, i32)** %7, align 8, !dbg !92
  %29 = call i32 (i32, i32)* %24(i32 %25, i32 %26, i32 (i32, i32)* %27, i32 (i32, i32)* %28), !dbg !88
  store i32 (i32, i32)* %29, i32 (i32, i32)** %10, align 8, !dbg !93
  %30 = load i32 (i32, i32)*, i32 (i32, i32)** %10, align 8, !dbg !94
  %31 = load i32, i32* %5, align 4, !dbg !95
  %32 = load i32, i32* %6, align 4, !dbg !96
  %33 = call i32 %30(i32 %31, i32 %32), !dbg !94
  ret i32 0, !dbg !97
}
...
!1 = !DIFile(filename: "test14.c", directory: "/home/hikonaka/compiler_2021/hw_2/assign2/test")
!2 = !{}
