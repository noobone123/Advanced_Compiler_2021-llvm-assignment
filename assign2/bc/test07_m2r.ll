...
define dso_local i32 @moo(i8 signext %0, i32 %1, i32 %2) #0 !dbg !32 {
  ...
  %4 = sext i8 %0 to i32, !dbg !47
  %5 = icmp eq i32 %4, 43, !dbg !49
  br i1 %5, label %6, label %7, !dbg !50
...
8:                                                ; preds = %7, %6
  %.01 = phi i32 (i32, i32)* [ @plus, %6 ], [ @minus, %7 ], !dbg !53
  call void @llvm.dbg.value(metadata i32 (i32, i32)* %.01, metadata !42, metadata !DIExpression()), !dbg !37
  %9 = icmp sgt i32 %1, 0, !dbg !54
  br i1 %9, label %10, label %12, !dbg !56

10:                                               ; preds = %8
  %11 = call i32 @clever(i32 %1, i32 %2, i32 (i32, i32)* %.01), !dbg !57
  call void @llvm.dbg.value(metadata i32 %11, metadata !45, metadata !DIExpression()), !dbg !37
  br label %14, !dbg !58

12:                                               ; preds = %8
  %13 = call i32 @clever(i32 %1, i32 %2, i32 (i32, i32)* @plus), !dbg !59
  call void @llvm.dbg.value(metadata i32 %13, metadata !45, metadata !DIExpression()), !dbg !37
  br label %14

14:                                               ; preds = %12, %10
  %.0 = phi i32 [ %11, %10 ], [ %13, %12 ], !dbg !60
  call void @llvm.dbg.value(metadata i32 %.0, metadata !45, metadata !DIExpression()), !dbg !37
  ret i32 %.0, !dbg !61
}
