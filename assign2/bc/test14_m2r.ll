...
9:                                                ; preds = %8, %6
  %.01 = phi i32 (i32, i32)* [ @plus, %6 ], [ @minus, %8 ], !dbg !44
  %.0 = phi i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)* [ @foo, %6 ], [ @clever, %8 ], !dbg !44
  ...
  %10 = call i32 (i32, i32)* %.0(i32 %1, i32 %2, i32 (i32, i32)* %.01, i32 (i32, i32)* @plus), !dbg !59
  call void @llvm.dbg.value(metadata i32 (i32, i32)* %10, metadata !51, metadata !DIExpression()), !dbg !44
  %11 = call i32 %10(i32 %1, i32 %2), !dbg !60
  ret i32 0, !dbg !61
}
