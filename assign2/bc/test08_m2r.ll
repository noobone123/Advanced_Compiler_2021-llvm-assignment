...
11:                                               ; preds = %10, %7
  %.0 = phi i32 (i32, i32)* [ @minus, %10 ], [ null, %7 ], !dbg !37
  call void @llvm.dbg.value(metadata i32 (i32, i32)* %.0, metadata !42, metadata !DIExpression()), !dbg !37
  br label %12

12:                                               ; preds = %11, %6
  %.1 = phi i32 (i32, i32)* [ @plus, %6 ], [ %.0, %11 ], !dbg !55
  call void @llvm.dbg.value(metadata i32 (i32, i32)* %.1, metadata !42, metadata !DIExpression()), !dbg !37
  %13 = call i32 @clever(i32 %1, i32 %2, i32 (i32, i32)* %.1), !dbg !56
  call void @llvm.dbg.value(metadata i32 %13, metadata !57, metadata !DIExpression()), !dbg !37
  ret i32 0, !dbg !59
}
